...
def init_service(endpoint_url, service_agreement_uuid, user_system_uuid, user_uuid, service_uuid):
...
def main(endpoint_url, service_agreement_uuid, user_system_uuid, user_uuid, service_uuid):

    service, inv_context = init_service(endpoint_url, service_agreement_uuid, user_system_uuid, user_uuid, service_uuid)
